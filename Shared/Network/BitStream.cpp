...
// These are RakNet allocators directly copied from its source as im too lazy to write my own
...
bool BitStream::IsNetworkOrderInternal(void)
{
	...
	static const bool isNetworkOrder = true;//(htonl(12345) == 12345);
